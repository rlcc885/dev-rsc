...
//            }
//
//            List<Legajo> listlegajo = session.createCriteria(Legajo.class).add(Restrictions.eq("entidadUE", _entidadUE)).setResultTransformer(CriteriaSpecification.DISTINCT_ROOT_ENTITY).list();
//
...
//                        criteriaCargoAsignado.add(Restrictions.eq("legajo", legajo)).add(Restrictions.eq("estado", helpers.Constantes.ESTADO_ACTIVO)).setResultTransformer(CriteriaSpecification.DISTINCT_ROOT_ENTITY);
