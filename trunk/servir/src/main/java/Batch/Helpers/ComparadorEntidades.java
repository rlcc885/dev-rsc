...
//        }
    ...
    /**
     * Compara 2 entidades unidad ejecutora y devueve si es una modificacion o
     * sin cambio
     *
     ...
     * @return - Devuelve una linea de informacion
     */
    public static String entidadUEs(Entidad eueOrigen, Entidad eueDestino) {
        String resultado = ResultadoOperacionCSV.SIN_CAMBIO;
        //TODO JZM 01/07/2012 Revisar si la funciona ha sido modificada
...
//            return resultado;
//        }
        resultado = ComparadorEntidades.comparadorDatos(eueOrigen.getDepartamento(), eueDestino.getDepartamento());
        if (resultado.equals(ResultadoOperacionCSV.MODIFICADO)) {
            return resultado;
        }
        resultado = ComparadorEntidades.comparadorDatos(eueOrigen.getDistrito(), eueDestino.getDistrito());
        if (resultado.equals(ResultadoOperacionCSV.MODIFICADO)) {
            return resultado;
        }
        resultado = ComparadorEntidades.comparadorDatos(eueOrigen.getProvincia(), eueDestino.getProvincia());
        if (resultado.equals(ResultadoOperacionCSV.MODIFICADO)) {
            return resultado;
        }
        resultado = ComparadorEntidades.comparadorDatos(eueOrigen.getEmailInstitucional(), eueDestino.getEmailInstitucional());
        if (resultado.equals(ResultadoOperacionCSV.MODIFICADO)) {
            return resultado;
        }
        //TODO JZM 01/07/2012 Revisar como obtener esta información
...
//            return resultado;
//        }
//        resultado = ComparadorEntidades.comparadorDatos(eueOrigen.getNivelGobierno(), eueDestino.getNivelGobierno());
//        if (resultado.equals(ResultadoOperacionCSV.MODIFICADO)) {
//            return resultado;
//        }
...
//        }
    ...
    public static LineaInformeCodigo cargos(Cargoxunidad corigen, Cargoxunidad cdestino) {
        ...
        lio.setCodigoEntidadUE(corigen.getUnidadorganica().getEntidad().getCue_entidad());
...
//        }
    ...
    public static LineaInformeCodigo unidadesOrganicas(UnidadOrganica corigen, UnidadOrganica cdestino) {
        ...
        liuo.setCodigoEntidadUE(corigen.getEntidad().getCue_entidad());
...
//        }
    ...
    public static LineaInformeTipoNumeroDocumento familiares(Familiar corigen, Familiar cdestino, String codigo_organismo) {
         ...
         * cdestino.getTrabajador().getTipoDocumento()));
         * if(lif.getResultado().equals(ResultadoOperacionCSV.MODIFICADO)){
         * return lif; }
         *
         * lif.setResultado(ComparadorEntidades.comparadorDatos(corigen.getTrabajador().getNroDocumento(),
         * cdestino.getTrabajador().getNroDocumento()));
         * if(lif.getResultado().equals(ResultadoOperacionCSV.MODIFICADO)){
         * return lif; }
         */
        ...
        /*
         * lif.setResultado(ComparadorEntidades.comparadorDatos(corigen.getTipoDocumento(),
         * cdestino.getTipoDocumento()));
         * if(lif.getResultado().equals(ResultadoOperacionCSV.MODIFICADO)){
         * return lif; }
         *
         * lif.setResultado(ComparadorEntidades.comparadorDatos(corigen.getNroDocumento(),
         * cdestino.getNroDocumento()));
         * if(lif.getResultado().equals(ResultadoOperacionCSV.MODIFICADO)){
         * return lif; }
         */
...
//        lip.setResultado(ComparadorEntidades.comparadorDatos(corigen.getClase(), cdestino.getClase()));
        ...
        /*
         * lip.setResultado(ComparadorEntidades.comparadorDatos(corigen.getTipo(),
         * cdestino.getTipo()));
         * if(lip.getResultado().equals(ResultadoOperacionCSV.MODIFICADO)){
         * return lip; }
         */
        ...
        /*
         * lip.setResultado(ComparadorEntidades.comparadorDatos(corigen.getTitulo(),
         * cdestino.getTitulo()));
         * if(lip.getResultado().equals(ResultadoOperacionCSV.MODIFICADO)){
         * return lip; }
         */
        ...
        /*
         * lip.setResultado(ComparadorEntidades.comparadorDatos(corigen.getFecha(),
         * cdestino.getFecha()));
         * if(lip.getResultado().equals(ResultadoOperacionCSV.MODIFICADO)){
         * return lip; }
         */
        ...
        /*
         * lip.setResultado(ComparadorEntidades.comparadorDatos(corigen.getTrabajador(),
         * cdestino.getTrabajador()));
         * if(lip.getResultado().equals(ResultadoOperacionCSV.MODIFICADO)){
         * return lip; }
         */
...
//        lit.setResultado(ComparadorEntidades.comparadorDatos(corigen.getRegimenPensionario(), cdestino.getRegimenPensionario()));
    ...
    public static LineaInformeTipoNumeroDocumento cargoasignado(CargoAsignado corigen, CargoAsignado cdestino, String numeroDocumento, String tipoDocumento, String codigo_organismo) {
        ...
        /*
         * System.out.println("CARGO ASIGNADO 0
         * "+corigen.getCargo().getCod_cargo() + " destino"
         * +cdestino.getCargo().getCod_cargo());
         * lica.setResultado(ComparadorEntidades.comparadorDatos(corigen.getCargo(),
         * cdestino.getCargo()));
...
//        }
    ...
    public static String comparadorDatos(Object dato1, Object dato2) {
        ...
        /*
         * if((dato1 == null && dato2 == null)) //sin modif return
         * ResultadoOperacionCSV.SIN_CAMBIO;
         *
         * if(dato2 != null){ if((dato1 == null && dato2.equals(""))) //sin
         * modif return ResultadoOperacionCSV.SIN_CAMBIO; }
         *
         * if(dato1 != null){ if((dato1.equals("") && dato2 == null)) //sin
         * modif return ResultadoOperacionCSV.SIN_CAMBIO; }
         *
         * if((dato1.equals("") && dato2.equals(""))) //sin modif return
         * ResultadoOperacionCSV.SIN_CAMBIO;
         *
         * if(dato1 == null) //modif return ResultadoOperacionCSV.MODIFICADO;
         *
         * if(dato2 == null) //modif return ResultadoOperacionCSV.MODIFICADO;
         *
         * if(!dato2.equals(dato1)) // modif return
         * ResultadoOperacionCSV.MODIFICADO;
         */
    ...
    public static String comparadorDatos(DatoAuxiliar da1, DatoAuxiliar da2) {
        ...
        if (!da2.getValor().equals(da1.getValor())) // modif
        {
            return ResultadoOperacionCSV.MODIFICADO;
        }

        /*
         * if((da1 == null && da2 == null)) //sin modif return
         * ResultadoOperacionCSV.SIN_CAMBIO; if(da2 != null){ if((da1 == null))
         * //sin modif return ResultadoOperacionCSV.SIN_CAMBIO; }
         * System.out.println("--------- jusque la"); if(da1 != null){ if(da2 ==
         * null) //sin modif return ResultadoOperacionCSV.SIN_CAMBIO; }
         *
         * if(da1 == null) //modif return ResultadoOperacionCSV.MODIFICADO;
         *
         * if(da2 == null) //modif return ResultadoOperacionCSV.MODIFICADO;
         *
         * if((da1.getValor() == null && da2.getValor() == null)) //sin modif
         * return ResultadoOperacionCSV.SIN_CAMBIO;
         *
         * if(da2.getValor() != null){ if((da1 == null &&
         * da2.getValor().equals(""))) //sin modif return
         * ResultadoOperacionCSV.SIN_CAMBIO; }
         *
         * if(da1.getValor() != null){ if((da1.getValor().equals("") && da2 ==
         * null)) //sin modif return ResultadoOperacionCSV.SIN_CAMBIO; }
         * if(da1.getValor() == null) //modif return
         * ResultadoOperacionCSV.MODIFICADO;
         *
         * if(da2.getValor() == null) //modif return
         * ResultadoOperacionCSV.MODIFICADO;
         *
         *
         * if(!da2.getValor().equals(da1.getValor())) // modif return
         * ResultadoOperacionCSV.MODIFICADO;
         */
    ...
    public static String comparadorDatos2(DatoAuxiliar da1, DatoAuxiliar da2) {
        if ((da1 == null && da2 == null)) //sin modif
        {
            return ResultadoOperacionCSV.SIN_CAMBIO;
        }
        ...
        if (da2.getValor() != null) {
            if ((da1 == null && da2.getValor().equals(""))) //sin modif
            {
                return ResultadoOperacionCSV.SIN_CAMBIO;
            }
        }
        ...
        if (da1.getValor() != null) {
            if ((da1.getValor().equals("") && da2 == null)) //sin modif
            {
                return ResultadoOperacionCSV.SIN_CAMBIO;
            }
        }
        if (da1.getValor() == null) //modif
        {
            return ResultadoOperacionCSV.MODIFICADO;
        }

        if (da2.getValor() == null) //modif
        {
            return ResultadoOperacionCSV.MODIFICADO;
        }
    ...
    public static String comparadorDate(Date date1, Date date2) {
        ...
        if ((date1 == null && date2 == null)) //sin modif
        {
            return ResultadoOperacionCSV.SIN_CAMBIO;
        }
        ...
        if (!sdf.format(date2).equals(sdf.format(date1))) // modif
        {
            return ResultadoOperacionCSV.MODIFICADO;
        }
