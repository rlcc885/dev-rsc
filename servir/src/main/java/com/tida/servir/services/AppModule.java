...
private ApplicationGlobals globals;
    ...
    public static void contributeServiceOverride(MappedConfiguration<Class, Object> configuration) {
        configuration.add(ClasspathURLConverter.class, new ClasspathURLConverterJBoss6());
    }
    ...
    public static void contributeApplicationDefaults(
        ...
        // FIXME Poner lo de abajo para producción 
    ...
    /**
     * To get binding in eventlinks with lists
     * @param configuration
     * @param bindingSource
     */
