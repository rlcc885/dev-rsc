...
var UpdateYourBrowserInit=function(){
    ...
    jQuery(document).ready(function(){
        ...
        if(((BrowserDetect.browser=="Internet Explorer")&&(parseInt(BrowserDetect.version)<=6))||((BrowserDetect.browser=="Chrome")&&(parseInt(BrowserDetect.version)<=10))||((BrowserDetect.browser=="Opera")&&(parseInt(BrowserDetect.version)<=9))||((BrowserDetect.browser=="Safari")&&(parseInt(BrowserDetect.version)<4))||((BrowserDetect.browser=="Firefox")&&(parseInt(BrowserDetect.version)<=15)))
        { 
